...
var Slovesnyi = (function () {
  ...
  var locales = {
    uk: {
      ...
      positions: "Твоя позиція випала навмання — спробуй її відстояти.", pro: "ЗА", con: "ПРОТИ",
    ...
    ru: {
      ...
      positions: "Сторона выпала случайно — попробуй её отстоять.", pro: "ЗА", con: "ПРОТИВ",
    ...
    en: {
      ...
      positions: "Your side is random. See if you can make a case for it.", pro: "FOR", con: "AGAINST",
