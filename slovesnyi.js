...
var Slovesnyi = (function () {
  ...
  var locales = {
    uk: {
      ...
      target: "Перемог для перемоги у грі", preparation: "Підготовка", speech: "Основний виступ", rebuttal: "Заперечення",
      ...
      rules: "2–8 гравців на одному пристрої. Гра обирає пару й призначає позиції. Після виступів разом вирішіть, хто був переконливішим. Переможець батлу отримує 1 бал, за нічию — ніхто.",
      positions: "Позиції призначено грою — спробуйте переконати навіть у тому, з чим не згодні!", pro: "ЗА", con: "ПРОТИ",
      ready: "До підготовки", early: "Почати раніше", endSpeech: "Завершити виступ", endRebuttal: "Завершити заперечення",
      rebuttalHint: "Спростуй аргумент суперника", voting: "Хто був переконливішим?", draw: "Нічия", result: "Результат батлу",
      point: "+1 перемога", drawResult: "Нічия — бали не нараховано", next: "Наступний батл", final: "Підсумки гри", winner: "Переможець",
    ...
    ru: {
      ...
      target: "Побед для победы в игре", preparation: "Подготовка", speech: "Основное выступление", rebuttal: "Возражение",
      ...
      rules: "2–8 игроков на одном устройстве. Игра выбирает пару и назначает позиции. После выступлений вместе решите, кто был убедительнее. Победитель батла получает 1 балл, при ничьей — никто.",
      positions: "Позиции назначены игрой — попробуйте убедить даже в том, с чем не согласны!", pro: "ЗА", con: "ПРОТИВ",
      ready: "К подготовке", early: "Начать раньше", endSpeech: "Завершить выступление", endRebuttal: "Завершить возражение",
      rebuttalHint: "Опровергни аргумент соперника", voting: "Кто был убедительнее?", draw: "Ничья", result: "Результат батла",
      point: "+1 победа", drawResult: "Ничья — баллы не начислены", next: "Следующий батл", final: "Итоги игры", winner: "Победитель",
    ...
    en: {
      ...
      target: "Wins needed to win the game", preparation: "Preparation", speech: "Main speech", rebuttal: "Rebuttal",
      ...
      rules: "2–8 players on one device. The game picks two players and assigns their sides. After the speeches, decide together who was more convincing. The duel winner earns 1 point; a draw awards none.",
      positions: "The game assigns your sides — try to persuade even when you disagree!", pro: "FOR", con: "AGAINST",
      ready: "Prepare", early: "Start early", endSpeech: "Finish speech", endRebuttal: "Finish rebuttal",
      rebuttalHint: "Challenge your opponent's argument", voting: "Who was more convincing?", draw: "Draw", result: "Duel result",
      point: "+1 win", drawResult: "Draw — no points awarded", next: "Next duel", final: "Game results", winner: "Winner",
