...
const WORD_GUESS_ACHIEVEMENTS = [
  ...
  {"id": "svitlohray-first-win", "game": "svitlohray", "reward": "💡", "titleKey": "achievementSvitlohrayFirstWinTitle", "descriptionKey": "achievementSvitlohrayFirstWinDescription", "category": "milestones"},
  {"id": "svitlohray-no-hint", "game": "svitlohray", "reward": "🧩", "titleKey": "achievementSvitlohrayNoHintTitle", "descriptionKey": "achievementSvitlohrayNoHintDescription", "category": "hints"},
  {"id": "svitlohray-big-picture", "game": "svitlohray", "reward": "🔲", "titleKey": "achievementSvitlohrayBigPictureTitle", "descriptionKey": "achievementSvitlohrayBigPictureDescription", "category": "milestones"},
  {"id": "svitlohray-all-sizes", "game": "svitlohray", "reward": "▦", "titleKey": "achievementSvitlohrayAllSizesTitle", "descriptionKey": "achievementSvitlohrayAllSizesDescription", "category": "milestones"},
  {"id": "svitlohray-ten-wins", "game": "svitlohray", "reward": "✨", "titleKey": "achievementSvitlohrayTenWinsTitle", "descriptionKey": "achievementSvitlohrayTenWinsDescription", "category": "milestones"},
  {"id": "svitlohray-twenty-five-wins", "game": "svitlohray", "reward": "🔆", "titleKey": "achievementSvitlohrayTwentyFiveWinsTitle", "descriptionKey": "achievementSvitlohrayTwentyFiveWinsDescription", "category": "milestones"},
  {"id": "svitlohray-colorist", "game": "svitlohray", "reward": "🎨", "titleKey": "achievementSvitlohrayColoristTitle", "descriptionKey": "achievementSvitlohrayColoristDescription", "category": "skill"},
  {"id": "svitlohray-new-mood", "game": "svitlohray", "reward": "🌈", "titleKey": "achievementSvitlohrayNewMoodTitle", "descriptionKey": "achievementSvitlohrayNewMoodDescription", "category": "skill"},
  {"id": "svitlohray-no-help", "game": "svitlohray", "reward": "🧠", "titleKey": "achievementSvitlohrayNoHelpTitle", "descriptionKey": "achievementSvitlohrayNoHelpDescription", "category": "streaks"},
  {"id": "svitlohray-patience", "game": "svitlohray", "reward": "🐢", "titleKey": "achievementSvitlohrayPatienceTitle", "descriptionKey": "achievementSvitlohrayPatienceDescription", "category": "secrets", "mystery": true, "hintKey": "achievementSvitlohrayPatienceDescription"},
  {"id": "slovesnyi-first-duel", "game": "slovesnyi", "reward": "🗣️", "titleKey": "achievementSlovesnyiFirstDuelTitle", "descriptionKey": "achievementSlovesnyiFirstDuelDescription", "category": "milestones"},
  {"id": "slovesnyi-first-game", "game": "slovesnyi", "reward": "🏆", "titleKey": "achievementSlovesnyiFirstGameTitle", "descriptionKey": "achievementSlovesnyiFirstGameDescription", "category": "milestones"},
  {"id": "slovesnyi-devils-advocate", "game": "slovesnyi", "reward": "😈", "titleKey": "achievementSlovesnyiDevilsAdvocateTitle", "descriptionKey": "achievementSlovesnyiDevilsAdvocateDescription", "category": "skill"},
...
const WORD_GUESS_ACHIEVEMENT_GAMES = [
  ...
  { id: "svitlohray", titleKey: "achievementGameSvitlohray", icon: "💡" },
  { id: "slovesnyi", titleKey: "achievementGameSlovesnyi", icon: "🗣️" },
...
const WORD_GUESS_TEXT = {
  uk: {
    ...
    achievementSvitlohrayNoHintDescription: "Заверши гру без підказки.",
    achievementSvitlohrayBigPictureTitle: "Велика картина",
    achievementSvitlohrayBigPictureDescription: "Заверши поле 5×5.",
    achievementSvitlohrayAllSizesTitle: "Три розміри",
    achievementSvitlohrayAllSizesDescription: "Заверши поля 3×4, 4×4 і 5×5.",
    achievementSvitlohrayTenWinsTitle: "Світлова звичка",
    achievementSvitlohrayTenWinsDescription: "Заверши 10 ігор у Світлограї.",
    achievementSvitlohrayTwentyFiveWinsTitle: "Не вимикай",
    achievementSvitlohrayTwentyFiveWinsDescription: "Заверши 25 ігор у Світлограї.",
    achievementSvitlohrayColoristTitle: "Колорист",
    achievementSvitlohrayColoristDescription: "Зміни кольори вручну й заверши гру.",
    achievementSvitlohrayNewMoodTitle: "Новий настрій",
    achievementSvitlohrayNewMoodDescription: "Обери інші кольори навмання й заверши гру.",
    achievementSvitlohrayNoHelpTitle: "Без допомоги",
    achievementSvitlohrayNoHelpDescription: "Заверши 5 ігор поспіль без підказок.",
    achievementSvitlohrayPatienceTitle: "Світло любить терплячих",
    achievementSvitlohrayPatienceDescription: "Заверши поле 5×5 за 75 або більше ходів.",
    achievementSlovesnyiFirstDuelTitle: "Є аргумент",
    achievementSlovesnyiFirstDuelDescription: "Виграй свій перший батл.",
    achievementSlovesnyiFirstGameTitle: "Переконав",
    achievementSlovesnyiFirstGameDescription: "Виграй першу партію у Словесному.",
    achievementSlovesnyiDevilsAdvocateTitle: "Адвокат диявола",
    achievementSlovesnyiDevilsAdvocateDescription: "Виграй батл на позиції ПРОТИ.",
    achievementSlovesnyiCrazyWinTitle: "І це я відстояв",
    achievementSlovesnyiCrazyWinDescription: "Виграй батл на божевільній темі.",
    achievementSlovesnyiThreeStreakTitle: "Серія доказів",
    achievementSlovesnyiThreeStreakDescription: "Виграй 3 батли поспіль.",
    achievementSlovesnyiBothSidesTitle: "Універсальний оратор",
    achievementSlovesnyiBothSidesDescription: "Виграй батли і ЗА, і ПРОТИ в одній партії.",
  ...
  ru: {
    ...
    achievementSvitlohrayNoHintDescription: "Заверши игру без подсказки.",
    achievementSvitlohrayBigPictureTitle: "Большая картина",
    achievementSvitlohrayBigPictureDescription: "Заверши поле 5×5.",
    achievementSvitlohrayAllSizesTitle: "Три размера",
    achievementSvitlohrayAllSizesDescription: "Заверши поля 3×4, 4×4 и 5×5.",
    achievementSvitlohrayTenWinsTitle: "Световая привычка",
    achievementSvitlohrayTenWinsDescription: "Заверши 10 игр в Цветоигре.",
    achievementSvitlohrayTwentyFiveWinsTitle: "Не выключай",
    achievementSvitlohrayTwentyFiveWinsDescription: "Заверши 25 игр в Цветоигре.",
    achievementSvitlohrayColoristTitle: "Колорист",
    achievementSvitlohrayColoristDescription: "Измени цвета вручную и заверши игру.",
    achievementSvitlohrayNewMoodTitle: "Новое настроение",
    achievementSvitlohrayNewMoodDescription: "Выбери другие цвета случайно и заверши игру.",
    achievementSvitlohrayNoHelpTitle: "Без помощи",
    achievementSvitlohrayNoHelpDescription: "Заверши 5 игр подряд без подсказок.",
    achievementSvitlohrayPatienceTitle: "Свет любит терпеливых",
    achievementSvitlohrayPatienceDescription: "Заверши поле 5×5 за 75 или больше ходов.",
    achievementSlovesnyiFirstDuelTitle: "Есть аргумент",
    achievementSlovesnyiFirstDuelDescription: "Выиграй свой первый батл.",
    achievementSlovesnyiFirstGameTitle: "Убедил",
    achievementSlovesnyiFirstGameDescription: "Выиграй первую игру в Словесном.",
    achievementSlovesnyiDevilsAdvocateTitle: "Адвокат дьявола",
    achievementSlovesnyiDevilsAdvocateDescription: "Выиграй батл на стороне ПРОТИВ.",
    achievementSlovesnyiCrazyWinTitle: "И это я отстоял",
    achievementSlovesnyiCrazyWinDescription: "Выиграй батл на безумной теме.",
    achievementSlovesnyiThreeStreakTitle: "Серия аргументов",
    achievementSlovesnyiThreeStreakDescription: "Выиграй 3 батла подряд.",
    achievementSlovesnyiBothSidesTitle: "Универсальный оратор",
    achievementSlovesnyiBothSidesDescription: "Выиграй батлы и ЗА, и ПРОТИВ в одной игре.",
  ...
  en: {
    ...
    achievementSvitlohrayNoHintDescription: "Solve a board without using a hint.",
    achievementSvitlohrayBigPictureTitle: "Big Picture",
    achievementSvitlohrayBigPictureDescription: "Solve a 5×5 board.",
    achievementSvitlohrayAllSizesTitle: "All Three Boards",
    achievementSvitlohrayAllSizesDescription: "Solve a 3×4, 4×4 and 5×5 board.",
    achievementSvitlohrayTenWinsTitle: "Light Habit",
    achievementSvitlohrayTenWinsDescription: "Solve 10 Lightplay boards.",
    achievementSvitlohrayTwentyFiveWinsTitle: "Keep It On",
    achievementSvitlohrayTwentyFiveWinsDescription: "Solve 25 Lightplay boards.",
    achievementSvitlohrayColoristTitle: "Colorist",
    achievementSvitlohrayColoristDescription: "Choose your own colors and solve the board.",
    achievementSvitlohrayNewMoodTitle: "New Mood",
    achievementSvitlohrayNewMoodDescription: "Use a random palette and solve the board.",
    achievementSvitlohrayNoHelpTitle: "No Help Needed",
    achievementSvitlohrayNoHelpDescription: "Solve 5 boards in a row without hints.",
    achievementSvitlohrayPatienceTitle: "Patience Pays Off",
    achievementSvitlohrayPatienceDescription: "Solve a 5×5 board in 75 moves or more.",
    achievementSlovesnyiFirstDuelTitle: "Case Made",
    achievementSlovesnyiFirstDuelDescription: "Win your first duel.",
    achievementSlovesnyiFirstGameTitle: "Persuasive",
    achievementSlovesnyiFirstGameDescription: "Win your first Word Duel game.",
    achievementSlovesnyiDevilsAdvocateTitle: "Devil's Advocate",
    achievementSlovesnyiDevilsAdvocateDescription: "Win a duel while arguing AGAINST.",
    achievementSlovesnyiCrazyWinTitle: "I Defended That",
    achievementSlovesnyiCrazyWinDescription: "Win a duel on a Crazy topic.",
    achievementSlovesnyiThreeStreakTitle: "Winning Argument",
    achievementSlovesnyiThreeStreakDescription: "Win 3 duels in a row.",
    achievementSlovesnyiBothSidesTitle: "Both Sides",
    achievementSlovesnyiBothSidesDescription: "Win duels on both sides in the same game.",
...
const modeConfigs = [
  ...
  },
  {
    id: "battle",
    title: "Словесний",
    description: "Батл аргументів",
    dataFile: "debates.json",
    available: true,
  },
];
...
function normalizeReleaseInfo(data) {
  ...
  const parsedCandidate = Number.parseInt(String(data && data.candidate || "").replace(/^c/i, ""), 10);
...
function updateMenuVersionInfo() {
  ...
  menuVersionInfo.textContent = `v${DATA_VERSION}${DATA_CANDIDATE ? `-c${DATA_CANDIDATE}` : ""}`;

  if (appSettingsVersion) {
    appSettingsVersion.textContent = `v${DATA_VERSION}${DATA_CANDIDATE ? `-c${DATA_CANDIDATE}` : ""}`;
  }
}
...
function readWordGuessAchievementsState() {
  ...
  const emptyState = {
    ...
    svitlohray: NewModeAchievements.normalizeStats(null),
    whoAmIGames: 0,
    whoAmIGuessed: 0,
    whoAmISkipped: 0,
    whoAmIYes: 0,
  ...
  try {
    ...
    return {
      ...
      svitlohray: NewModeAchievements.normalizeStats(parsed.svitlohray),
...
function getWordGuessAchievementGameCopy(definition) {
  ...
  const games = {
    ...
    svitlohray: { icon: "💡", label: getWordGuessText("achievementGameSvitlohray") },
    slovesnyi: { icon: "🗣️", label: getWordGuessText("achievementGameSlovesnyi") },
...
function getAppNavigationLevel(screenName) {
  if (screenName === "slovesnyiSetup") return "setup";
  if (screenName === "slovesnyiFinal") return "result";
  if (screenName === "menu") {
    return "menu";
  }
...
function renderModes() {
  ...
  activeModes.forEach((mode) => {
    ...
    const modeIcons = {
      ...
      battle: "assets/game-icons/slovesnyi.svg",
    };
    const iconWrap = document.createElement("span");
    iconWrap.className = "mode-card-icon";
    iconWrap.setAttribute("aria-hidden", "true");
    const iconFallback = appendTextElement(iconWrap, "span", "mode-card-icon-fallback", mode.id === "battle" ? "☏" : "?");
    ...
    const renderedTitle = mode.id === "battle" ? Slovesnyi.text("title", selectedWordGuessLanguage) : localeKeys ? getWordGuessText(localeKeys[0]) : mode.title;
    const renderedDescription = mode.id === "battle" ? Slovesnyi.text("description", selectedWordGuessLanguage) : localeKeys ? getWordGuessText(localeKeys[1]) : mode.description;
