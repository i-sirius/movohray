...
- 180 тем трьома мовами у `debates.json`; 12 категорій; 60 easy, 60 normal, 60 crazy. Історія показів зберігається локально між партіями.
- Окремі `slovesnyi-engine.js`, `slovesnyi.js` та scoped `slovesnyi.css`; наявні режими збережено. Події для майбутньої інтеграції досягнень є, нових нагород у c1 немає.
- Build: `2026-09-07`; revision: `0.6.7-20260907-c1`; cache: `movohray-cache-v0.6.7-b20260907-c1`; `candidate: "c1"`; `required: true`.
- Це локальний candidate для review, без production tag і push. Архітектура та перевірки: [CANDIDATE_0.6.7-c1.md](CANDIDATE_0.6.7-c1.md).

## 0.6.6a

- «Хто я?»: виправлено ширину фінального fullscreen overlay на desktop; обмеження ширини картки збережено.
- Build: `2026-08-25`; PWA revision: `0.6.6a-20260825`; cache: `movohray-cache-v0.6.6a-b20260825`; `required: true`.
