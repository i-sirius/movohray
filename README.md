...
Додано звукові сигнали для ігрової логіки: “Вгадано”, “Пропущено”, завершення командного раунду та фінальне завершення гри. Звуки створюються через Web Audio API без зовнішніх аудіофайлів, тому гра лишається статичною і працює на GitHub Pages/PWA.
