...
## 0.4.33
- У режимі “Вгадай слово” поле тепер сильніше стискає клітинки для 6–7 спроб на мобільних екранах, щоб клавіатура, “Ввести” і Backspace поміщалися без прокрутки.
- Вирівняно кнопку правил у верхній панелі підказок.
- Виправлено перевірку режиму “з повторами літер”: повтори більше не блокуються в цьому режимі.
- Розширено словники для 6 і 7 літер, особливо допустимі слова для введення та режими з повторами.
