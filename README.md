...
У режимі “Вгадай слово” додані різні фінальні анімації: для перемоги — конфеті й феєрверки, для програшу — розліт емодзі з реакціями. Анімації не блокують кнопки у фінальному вікні й поважають системне налаштування `prefers-reduced-motion`.
